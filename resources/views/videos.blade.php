...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<body>
		<div class="hero vh-100 px-5 pt-3">
			...
			<!-- tips -->
			<div class="container">
				<div class="h1 fw-bold text-center mt-5 mb-5">Videos</div>
				<div class="row">
					<div id="myCarousel" class="carousel slide carousel-dark carousel-fade vidcarousel">
						...
						<button class="carousel-control-next vidcarouselright" type="button" data-bs-target="#myCarousel" data-bs-slide="next">
				...
				<!-- articles section -->
				<div class="h1 fw-bold text-center mt-5 mb-5">Articles</div>
				<div class="row">
